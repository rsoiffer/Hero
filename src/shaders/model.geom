...
void main()
{
    ...
    float occ = NORMAL_TO_OCC[normal];
    ...
    if (occlusion[0].x + occlusion[0].z < occlusion[0].y + occlusion[0].w) {
        ...
        fragColor = color[0];
        fragOcclusion = occlusion[0].x * occ;
        fragFog = fog;
        fragPos = pos;
        EmitVertex();
        ...
        fragColor = color[0];
        fragOcclusion = occlusion[0].y * occ;
        fragFog = fog;
        fragPos = pos + dir1;
        EmitVertex();
        ...
        fragColor = color[0];
        fragOcclusion = occlusion[0].w * occ;
        fragFog = fog;
        fragPos = pos + dir2;
        EmitVertex();
        ...
        fragColor = color[0];
        fragOcclusion = occlusion[0].z * occ;
        fragFog = fog;
